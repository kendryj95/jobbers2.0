    ...
    public function recomendacion()
    {
       ...
       $datos_finales = array();
        ...
        foreach ($ofertas_empresa as $key) {
          ...
          $sql_recomendados=
            "
            SELECT t10.nombre_aleatorio, t1.id,concat(t2.nombres,' ',t2.apellidos) as nombre, t2.id_sexo,TIMESTAMPDIFF(YEAR,t2.fecha_nac,CURDATE()) AS edad,t5.provincia,t6.localidad, t7.t_experiencias+t8.t_educacion as total FROM tbl_usuarios t1
