												...
												<tr >
													...
													<td style="width: 60%;">
														<div class="table-list-title">
															<h3><a href="detalleoferta/2" title=""><?php echo $key->descripcion;?></a></h3>
														</div>
													</td>
													
													<td style="text-align:right;width: 20%;">
														<?php if ($contador!=1): ?>
																<ul class="action_job"> <li><span>Eliminar</span><a href="categoriadel/<?php echo $key->id;?>" title=""><i class="la la-trash-o"></i></a></li></ul>
														<?php endif ?> 
													</td>
