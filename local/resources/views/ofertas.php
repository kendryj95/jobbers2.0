              ...
              <form action="ofertas" method="POST" id="form_filter">
                ...
                <div class="widget">
                  ...
                  <div class="type_widget" style="">
                    <p class="flchek"><input type="radio" onclick="filter()" name="antiguedad" id="ant_1" value="1">
                      <label id="label_ant_1" for="ant_1">Todo
                      </label> (<?= $antiguedad[0]->cantidad_todo ?>)</p>
                    <br>
                    <p class="flchek"><input type="radio" onclick="filter()" name="antiguedad" id="ant_2" value="2">
                      <label id="label_ant_2" for="ant_2">Hoy
                      </label> (<?= $antiguedad[0]->cantidad_hoy ?>)</p>
                    <br>
                    <p class="flchek"><input type="radio" onclick="filter()" name="antiguedad" id="ant_3" value="3">
                      <label id="label_ant_3" for="ant_3">Última semana
                      </label> (<?= $antiguedad[0]->cantidad_last_week ?>)</p>
                    <br>
                    <p class="flchek"><input type="radio" onclick="filter()" name="antiguedad" id="ant_4" value="4">
                ...
                <div class="widget">
                  ...
                  <div class="type_widget" style="">
                    ...
                    <p class="flchek">
                      ...
                      <label id="label_prov_<?= $key->id_provincia ?>" for="prov_<?= $key->id_provincia ?>"><?= $key->provincia ?> 
                      </label> (<?= $key->cantidad ?>)
                    </p>
                    <?php  
                ...
                <div class="widget">
                  ...
                  <div class="type_widget" style="">
                    ...
                    <p class="flchek">
                      ...
                      <label id="label_loc_<?= $key->id_localidad ?>" for="loc_<?= $key->id_localidad ?>"><?= $key->localidad ?> 
                      </label> (<?= $key->cantidad ?>)
                    </p>
                    <?php  
                      if ($contador>10){break;}
                  ...
                  <div class="type_widget" style="">
                    <?php foreach ($disponibilidad as $key): ?>
                      <p class="flchek">
                        ...
                        <label id="label_disp_<?= $key->id_disponibilidad ?>" for="disp_<?= $key->id_disponibilidad ?>"><?= $key->nombre ?> 
                        </label> (<?= $key->cantidad ?>)
                      </p>
                    <?php endforeach ?>
                  </div>
                    ...
                    <div class="simple-checkbox">
                      ...
                      ?>
                        <p class="flchek">
                          ...
                          <label id="label_area_<?= $key->id_area ?>" for="area_<?= $key->id_area ?>"><?= $key->nombre ?>  
                          </label> (<?= $key->cantidad ?>)
                        </p>
                      <?php  
                        if($contador>10){break;}
                    ...
                    <div class="simple-checkbox">
                      ...
                      ?>
                        <p class="flchek">
                          ...
                          <label id="label_sect_<?= $key->id_sector ?>" for="sect_<?= $key->id_sector ?>"><?= $key->nombre ?> 
                          </label> (<?= $key->cantidad ?>)
                        </p>
                      <?php  
                        if($contador>10){break;}
                    ...
                    <div class="simple-checkbox">
                      ...
                      ?>
                        <p class="flchek">
                          ...
                          <label id="label_sal_<?= $key->id_salario ?>" for="sal_<?= $key->id_salario ?>"><?= $key->salario ?>
                          </label> (<?= $key->cantidad ?>)
                        </p>
                      <?php
                        if($contador>10){break;}
                  ...
                  <div class="specialism_widget" style="display: block;">
                    <div class="simple-checkbox">
                      ...
                      <p class="flchek">
                        ...
                        <label id="label_exp_<?= $key->id_experiencia ?>" for="exp_<?= $key->id_experiencia ?>"><?= $datos ?>
                        </label> (<?= $key->cantidad ?>)
                      </p>
                      <?php endforeach ?>
                    </div>
                    ...
                    <div class="simple-checkbox">
                      <?php foreach($genero as $key): ?>
                        ...
                        <p class="flchek">
                          ...
                          <label id="label_gen_<?= $key->id_genero ?>" for="gen_<?= $key->id_genero ?>"><?= $key->descripcion ?>
                          </label> (<?= $key->cantidad ?>)
                        </p>
                      <?php endforeach ?>
                    </div>
