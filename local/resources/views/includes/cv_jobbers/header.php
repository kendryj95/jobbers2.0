<?php
		...
		Fpdf::Cell(190,8,utf8_decode(strtoupper($datos_personales[0]->nombres." ".$datos_personales[0]->apellidos)),0,1,'C','true');
		Fpdf::SetFont('Arial','',8); 
		...
		else
		{
			...
			Fpdf::Image('uploads/'.$foto[0]->nombre_aleatorio, 15 ,8, 25 , 35,$foto[0]->extencion, '');
