          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body" style="padding-top: 0px;"> 
                <div class="col-lg-12">
                           <form id="formulario_alias" action="actarch" method="post">
                            ...
                            <div class="pf-field">
                                <input name="alias" type="text" placeholder="Alias del archivo...">
                            </div>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-xs btn-primary" onClick="$('#formulario_alias').submit()">Aplicar</button>
