                                    ...
                                    <div class="padding-left">
                                        <div class="manage-jobs-sec addscroll">
                                            ...
                                            <div class="extra-job-info" style="margin-bottom: 30px;background-color: #f0f0f0;">
                                                <span style=""><span style="font-size: 24px;"><?php echo ($datos_resumen[0]->cantidad+$datos_resumen[1]->cantidad);?></span><strong></strong></span>
                                                <span><i class="la la-venus"></i><strong><?php echo $datos_resumen[0]->cantidad;?></strong><a href="noticias/categorias" title="">Hombres</a></span>
                                                <span><i class="la la-mars"></i><strong><?php echo $datos_resumen[1]->cantidad;?></strong><a href="noticias/categorias" title="">Mujeres</a></span>
                                            </div>
