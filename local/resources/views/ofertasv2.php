                    ...
                    <div class="col-lg-9 column" id="offers" style="padding-top: 64px;">
                        ...
                        <div class="col-xs-2" style="padding-left: 0px;">
                         ...
                         <div class="col-xs-3" style="padding-left: 0px; text-align: right;padding-right: 0px;">
                            <button type="button" onclick="location.href='ofertas'" title="Limpiar filtros" class="btn btn-success" style="margin-top: 0px;height: 49px;width: 50px;float: right;">
