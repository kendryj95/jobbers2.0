                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="video" name="fname" placeholder="Nombre de la empresa" type="text" value="<?php echo validar($empresa[0]->video_youtube)?>">
                                                            </input>
                                                        </div>
                                                    </div>  
                                                </div> 
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput4">
                                                             ...
                                                             <input maxlength="50" class="form-control" id="linkedin" name="" placeholder="Teléfono Celular" type="text" value="<?php echo validar($empresa[0]->linkedin)?>">
                                                            </input>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput4">
                                                             ...
                                                             <input maxlength="50" class="form-control" id="facebook" name="" placeholder="Teléfono Fijo" type="text" value="<?php echo validar($empresa[0]->facebook)?>">
                                                            </input>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput4">
                                                             ...
                                                             <input maxlength="50" class="form-control" id="twitter" name="" placeholder="Correo de contacto" type="text"  value="<?php echo validar($empresa[0]->twitter)?>">
                                                            </input>
                                                        </div>
                                                    </div> 
                                                </div> 
